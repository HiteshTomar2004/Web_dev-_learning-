...
class Clothing extends Product{
  ...
  constructor(productDetails){
    ...
    //if the class is empty it will run the parent's constructor by default
    this.sizeChartLink = productDetails.sizeChartLink;
  }
  //super.extraInfoHTML(); to call parent's method
  extraInfoHTML(){//Method Overriding:- overriding parent's method
    return `
